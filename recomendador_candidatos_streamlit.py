...
url_applicants = "https://huggingface.co/datasets/thiagovgs/meu-projeto-dados/resolve/main/applicants.json"
# df_applicants = pd.read_json(url_applicants, orient='index').reset_index().rename(columns={"index": "codigo_candidato"})
